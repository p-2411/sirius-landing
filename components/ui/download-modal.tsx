...
const DOWNLOAD_URL =
  "https://github.com/p-2411/sirius-releases/releases/download/v0.7.1/Sirius-0.7.1-arm64.dmg";
...
function DownloadDialog({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-label="Download Sirus for Mac"
      ...
      >
        <div className="flex items-start justify-between gap-4">
          <h2 className="font-display text-[22px] font-normal leading-tight text-[var(--color-ink-1)]">
            {done ? "You're in." : "Download Sirus for Mac"}
          </h2>
          <button
            type="button"
            onClick={onClose}
