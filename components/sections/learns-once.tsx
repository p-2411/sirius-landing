    ...
    <section id="learns-once" className="scroll-mt-24 py-24 md:py-32">
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_1fr] lg:gap-16">
          ...
          <RevealGroup className="relative" stagger={0.18}>
            {/* First run — you guide it */}
            <RevealItem className="rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-surface-1)] p-5">
            ...
            <RevealItem className="my-3 flex items-center justify-center">
            ...
            <RevealItem className="rounded-[var(--radius-lg)] border border-[rgba(167,219,178,0.35)] bg-[var(--color-surface-1)] p-5">
              <span className="font-mono text-[10px] uppercase tracking-[0.18em] text-[var(--color-ink-3)]">
                Every run after · just ask
              </span>
              <div className="mt-3 flex flex-col gap-2">
